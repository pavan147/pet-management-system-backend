...
public interface PetMedicalRepository extends JpaRepository<PetMedical, Long> {
    ...
    List<PetMedical> findByPetIdInOrderByVisitDateDescPetMedicalIdDesc(List<Long> petIds);

    List<PetMedical> findByPetIdOrderByVisitDateDesc(Long petId);

    Optional<PetMedical> findTopByPetIdOrderByVisitDateDescPetMedicalIdDesc(Long petId);
